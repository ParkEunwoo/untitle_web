...
class ModifyForm extends Component{
  ...
  componentWillMount() {
    const {type, title, explain, startDate, endDate, recruitNum} = this.props;
  ...
  render(){
    return (
      <Box>
        <BoxTop>멘토링 / 스터디 / 프로젝트 수정</BoxTop>
        <Form onSubmit= {this.handleSubmit}>
        <Title><Label>과목명</Label><InputTitle type="text" name="title" onChange={this.handleChange} value={this.state.title}/></Title>
        ...
        <InputDateStart type="date" name="startDate"onChange= {this.handleChange} value={this.state.startDate}/> ~ 
        <InputDateEnd type="date" name="endDate" onChange= {this.handleChange} value={this.state.endDate}/></Date>
        
        <RecruitNum><Label>모집인원</Label> <Input type="number" name="recruitNum" onChange={this.handleChange} value={this.state.recruitNum}/>명</RecruitNum>
